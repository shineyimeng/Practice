...
float Calculation_Accuracy=0.0001;/*定义精确度*/
...
int Number_PV=0;
int Number_SB=0;
float Transmission_Matrix[Const_Value][7];  /*线路参数矩阵*/
...
FILE *Output_File;
int index;   /*迭代次数*/
float PV_Voltage[Const_Value]={0};
...
void Read_Data()
{
    ...
    for(index_1=Number_PQ;index_1<Number_PQ+Number_PV;index_1++)
    {
        PV_Voltage[index_1]=Load_Buses[index_1][3];
    }
	printf("读取数据完成\n"); 
    ...
    fprintf(Output_File,"支路数据:\n节点序号 节点序号 电阻    电抗    电导    电纳   非标变比\n");
    for(index_1=0;index_1<Number_Line;index_1++)
    {
        fprintf(Output_File,"%1.0f        %1.0f        %5.4f  %5.4f  %5.4f  %5.4f  %5.4f\n",Transmission_Matrix[index_1][0],Transmission_Matrix[index_1][1],Transmission_Matrix[index_1][2],Transmission_Matrix[index_1][3],Transmission_Matrix[index_1][4],Transmission_Matrix[index_1][5],Transmission_Matrix[index_1][6]);
    }
    fprintf(Output_File,"********************************************************************\n");
...
void Form_Y()
{
    ...
    for(index_1=0;index_1<Number_Line;index_1++)
    {
        if(Transmission_Matrix[index_1][1]!=0)
        {
            /*考虑并行支路*/
            if((Transmission_Matrix[index_1][2]!=0)&&(Transmission_Matrix[index_1][3])!=0)
            {
                G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1]=G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1]-Transmission_Matrix[index_1][2]/(pow(Transmission_Matrix[index_1][2],2)+pow(Transmission_Matrix[index_1][3],2));
                ...
                B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1]=B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1]+Transmission_Matrix[index_1][3]/(pow(Transmission_Matrix[index_1][2],2)+pow(Transmission_Matrix[index_1][3],2));
            ...
            {
                G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1]=G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1]+Transmission_Matrix[index_1][4];
                G[(int)Transmission_Matrix[index_1][1]-1][(int)Transmission_Matrix[index_1][0]-1]=G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1];
                B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1]=B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1]+Transmission_Matrix[index_1][5];
                B[(int)Transmission_Matrix[index_1][1]-1][(int)Transmission_Matrix[index_1][0]-1]=B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1];
            }
        }
        else
        /*对地支路*/
        {
            if((Transmission_Matrix[index_1][2]!=0)&&(Transmission_Matrix[index_1][3])!=0)
            {
                G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][0]-1]=-Transmission_Matrix[index_1][2]/(pow(Transmission_Matrix[index_1][2],2)+pow(Transmission_Matrix[index_1][3],2));
                B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][0]-1]=Transmission_Matrix[index_1][3]/(pow(Transmission_Matrix[index_1][2],2)+pow(Transmission_Matrix[index_1][3],2));
            }
            else
            {
                G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][01]-1]=-Transmission_Matrix[index_1][4];
                B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][0]-1]=-Transmission_Matrix[index_1][5];
            }
        }
    }
    /*非标变比*/
    for(index_1=0;index_1<Number_Line;index_1++)
    {
        if(Transmission_Matrix[index_1][6]!=1)
        {
            G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][0]-1]=G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][0]-1]+(1/pow(Transmission_Matrix[index_1][6],2)-1)*G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1];
            B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][0]-1]=B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][0]-1]+(1/pow(Transmission_Matrix[index_1][6],2)-1)*B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1];
            //JJ变化量为0
            G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1]=G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1]-(1/Transmission_Matrix[index_1][6]-1)*G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1];
            B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1]=B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1]-(1/Transmission_Matrix[index_1][6]-1)*B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1];
            G[(int)Transmission_Matrix[index_1][1]-1][(int)Transmission_Matrix[index_1][0]-1]=G[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1];
            B[(int)Transmission_Matrix[index_1][1]-1][(int)Transmission_Matrix[index_1][0]-1]=B[(int)Transmission_Matrix[index_1][0]-1][(int)Transmission_Matrix[index_1][1]-1];
        }
    }
...
void Calculate_Unblanced_Value()
{
    ...
    for(index_1=0;index_1<Number_PQ+Number_PV;index_1++)
    {
    ...
    for(index_1=Number_PQ;index_1<(Number_PQ+Number_PV);index_1++)
    {
        fprintf(Output_File,"Delta_P%d=%f   Delta_U^2 %d=%f\n",index_1+1,Delta_PQ[2*index_1],index_1+1,Delta_PQ[2*index_1+1]);
    }
}
...
void Form_Jacobi_Matric()
{
    ...
    float R[Const_Value][Const_Value]={0};
    float S[Const_Value][Const_Value]={0};
    ...
    for(index_1=0;index_1<Number_Buses;index_1++)
    {
        for(index_2=0;index_2<Number_Buses;index_2++)
        {
            ...
            else
            {
                ...
                R[index_1][index_1]=2*Load_Buses[index_1][4];
                S[index_1][index_1]=2*Load_Buses[index_1][3];
            }
        }
    }
    for(index_1=0;index_1<Number_PQ;index_1++)
    {
        for(index_2=0;index_2<Number_PQ+Number_PV;index_2++)
        {
    ...
    for(index_1=Number_PQ;index_1<Number_PQ+Number_PV;index_1++)
    {
        for(index_2=0;index_2<Number_PQ+Number_PV;index_2++)
        {
            Jacobi_Matric[2*index_1][2*index_2]=H[index_1][index_2];
            Jacobi_Matric[2*index_1][2*index_2+1]=N[index_1][index_2];
            Jacobi_Matric[2*index_1+1][2*index_2]=R[index_1][index_2];
            Jacobi_Matric[2*index_1+1][2*index_2+1]=S[index_1][index_2];
        }
    }
	printf("形成雅可比矩阵完成\n"); 
    
    fprintf(Output_File,"----------------------------计算雅可比矩阵---------------------------\n");
    for(index_1=0;index_1<2*(Number_PQ+Number_PV);index_1++)
    {
        fprintf(Output_File,"|");
        for(index_2=0;index_2<2*(Number_PQ+Number_PV);index_2++)
        {
...
void Solve_Equations(float A[][2*Const_Value],float B[],float X[])
{
    ...
    int Number_Matrix;
    float Temp_Variable;
	Number_Matrix=2*(Number_PQ+Number_PV);
    ...
    {
        fprintf(Output_File,"Delta_f%d=%f\nDelta_e%d=%f\n",index_1/2+1,X[index_1],index_1/2+1,X[index_1+1]);
    }
}
...
void Calculate_Fixed_Value()
{
    ...
    for(index_1=1;index_1<Number_PQ;index_1++)
    {
    ...
    for(index_1=Number_PQ;index_1<Number_PQ+Number_PV;index_1++)
    {
        Temp_Value=PV_Voltage[index_1]*Load_Buses[index_1][3]/sqrt(pow(Load_Buses[index_1][3],2)+pow(Load_Buses[index_1][4],2));
        Load_Buses[index_1][4]=PV_Voltage[index_1]*Load_Buses[index_1][4]/sqrt(pow(Load_Buses[index_1][3],2)+pow(Load_Buses[index_1][4],2));
        Load_Buses[index_1][3]=Temp_Value;
    }
    printf("计算修正值完成\n");
    fprintf(Output_File,"修正电压值：\n");
    for(index_1=0;index_1<Number_PQ;index_1++)
    {
        fprintf(Output_File,"U%d=%f+j%f\n",index_1+1,Load_Buses[index_1][3],Load_Buses[index_1][4]);
    }
}
...
void Powerflow_Results()
{
    ...
    for(index_1=0;index_1<Number_Buses;index_1++)
    {
        Load_Active_Power[Number_Buses-1][2]=Load_Active_Power[Number_Buses-1][2]+Load_Buses[Number_Buses-1][3]*(G[2][index_1]*Load_Buses[index_1][3]-B[2][index_1]*Load_Buses[index_1][4])+Load_Buses[Number_Buses-1][4]*(G[2][index_1]*Load_Buses[index_1][4]+B[2][index_1]*Load_Buses[index_1][3]);
        Load_Reactive_Power[Number_Buses-1][2]=Load_Reactive_Power[Number_Buses-1][2]+Load_Buses[Number_Buses-1][4]*(G[2][index_1]*Load_Buses[index_1][3]-B[2][index_1]*Load_Buses[index_1][4])-Load_Buses[Number_Buses-1][3]*(G[2][index_1]*Load_Buses[index_1][4]+B[2][index_1]*Load_Buses[index_1][3]);
    }
    for(index_1=0;index_1<Number_Buses;index_1++)
    {
        for(index_2=0;index_2<Number_Buses;index_2++)
